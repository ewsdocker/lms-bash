...
source $testlibDir/installDirs.bash

source $testlibDir/stdLibs.bash
source $testlibDir/cliOptions.bash

source $testlibDir/commonVars.bash
...
source $testlibDir/testDump.bash
source $testlibDir/testUtilities.bash
...
source $testlibDir/openLog.bash
source $testlibDir/startInit.bash
...
source $testlibDir/scriptEnd.bash

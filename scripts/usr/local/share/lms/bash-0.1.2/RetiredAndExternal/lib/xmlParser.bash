...
#   	By glejeune
#
#			https://gist.github.com/glejeune/6935095
#
# ****************************************************************************
# ****************************************************************************

declare -r lmslib_xmlParser="0.0.1"	# version of library
...
#	_close_xml
#
# 		This function is called once for each file. It terminates the parser
#
# Type: private
# Parameters: none
# Return: nothing
...
#	_read_dom
#
#	This function read the DOM. It is called for every XML tags found.
#
# 	***************************************************************************
#
...
#  		* XML_TAG_NAME : Name of the current tag.
#						 If the current tag is a close tag,
#						    the leading "/" is present in the tag name
#  		* XML_TAG_TYPE : Type of the current tag. The value can be
#						 "OPEN", "CLOSE", "OPENCLOSE", "COMMENT" or "INSTRUCTION"
#  		* XML_COMMENT : If the current tag is of type "COMMENT",
#							this variable contains the text of the comment
...
_read_dom()
{
	...
	if [ $XML_TAG_NAME_FIRST_CHAR = "!" ] ; then
		...
		# If the last character of the XML entity is a "/" the tag is an "openclose" tag
...
#	get_attribute_value
#
#		This function allow you to get the value of the attribute
#				which name is passed as parameter
#
# Parameters:
...
#     lmsRDomHasAtt "name"
#     if [ "$?" = 1 ] ; then
#       lmsRDomSetAtt "name" "new value for name"
#     fi
#
# ****************************************************************************
lmsRDomSetAtt()
...
print_entity()
{
	if [ "$XML_TAG_TYPE" = "COMMENT" ]
	then
		printf "<!-- %s --" "$XML_COMMENT"
	elif [ "$XML_TAG_TYPE" = "INSTRUCTION" ]
	then
